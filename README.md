...
Страница называется `index` и находится по адресу [http://127.0.0.1:8000](http://127.0.0.1:8000). Отображает основную информацию и главное меню.
...
Её можно найти по адресу [127.0.0.1:8000/contacts](127.0.0.1:8000/contacts). На ней находятся необходимые сведения, содержащие адреса и телефоны, а также карта.
